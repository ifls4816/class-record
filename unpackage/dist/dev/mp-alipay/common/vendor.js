...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__D01EDE1",
    appName: "class-record-miniprogram",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const navigateTo = my.canIUse("page.getOpenerEventChannel") ? {} : navigateTo$1();
...
function initRuntimeSocketService() {
  const hosts = "192.168.31.210,127.0.0.1";
  const port = "8090";
  const id2 = "mp-alipay_qTjNlp";
...
function setRef(ref2, refValue, refs, setupState, isRefInVFor = false) {
  if (isRef(ref2)) {
    ref2.value = refValue;
  ...
  !function(t2, e2) {
    ...
    var _ = function() {
      ...
      return m2.parse = function(t3) {
        ...
        var n2, o3 = b.p(t3), f3 = "set" + (this.$u ? "UTC" : ""), l2 = (n2 = {}, n2[a] = f3 + "Date", n2[d] = f3 + "Date", n2[c] = f3 + "Month", n2[h] = f3 + "FullYear", n2[u] = f3 + "Hours", n2[s2] = f3 + "Minutes", n2[i] = f3 + "Seconds", n2[r] = f3 + "Milliseconds", n2)[o3], $2 = o3 === a ? this.$D + (e3 - this.$W) : e3;
        if (o3 === c || o3 === h) {
        ...
        var r2 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i2 = b.z(this), s3 = this.$H, u2 = this.$m, a2 = this.$M, o3 = n2.weekdays, c2 = n2.months, f3 = n2.meridiem, h2 = function(t4, n3, i3, s4) {
