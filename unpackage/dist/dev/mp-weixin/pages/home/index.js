      ...
      return common_vendor.e({
        ...
        f: common_vendor.f(calendarDays.value, (day, index, i0) => {
          return common_vendor.e({
            ...
            i: day.hasRecord ? 1 : "",
            j: common_vendor.o(($event) => selectDate(day), day.dateStr || `empty-${index}`)
          });
        }),
        ...
        k: common_vendor.f(todayRecords.value, (record, index, i0) => {
          return common_vendor.e({
            ...
            h: common_vendor.o(($event) => showActionSheet(record, index), `${record.studentId}-${record.time[0]}-${index}`)
          });
        }),
